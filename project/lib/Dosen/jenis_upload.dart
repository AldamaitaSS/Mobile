                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const CertificationUploadForm(jenis: 'Sertifikasi'),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF1F4C97), // Latar belakang biru tua
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const CertificationUploadForm(jenis: 'Pelatihan'),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
