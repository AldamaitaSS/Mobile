...
class SertifikasiUploadForm extends StatefulWidget {
  final String jenis;

  const SertifikasiUploadForm({super.key, required this.jenis});

  @override
  _SertifikasiUploadFormState createState() => _SertifikasiUploadFormState();
}

class _SertifikasiUploadFormState extends State<SertifikasiUploadForm> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate() && _selectedFile != null && _jenisId != null) {
      ...
      const apiUrl = "http://127.0.0.1:8000/api/upload_sertifikasi";
